...
export domain_name=`az rest --method get --url https://graph.microsoft.com/v1.0/domains --query 'value[?isDefault].id' -o tsv`

# Set, export and store app name
export app_name="sp_terraform_"${domain_name}"_"${RANDOM}
...
export object_id=`az ad app create --display-name ${app_name} \
